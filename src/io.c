...
// Version history:
// 1.1: added the machine (NTSC/PAL) tag to the music header

#define FAM_MAGIC "FAM"
#define FAM_VERSION_MAJOR 1
#define FAM_VERSION_MINOR 1
...
static FamResult parse_header(BufferReader* reader, FamHeader* out) {
    ...
    // The machine tag was added in v1.1
    // Older files predate NTSC/PAL awareness and are NTSC by default
    out->machine = FAM_MACHINE_NTSC;
